...
_register(0x20, "instance-of", "22c", 2, ref_kind="type", can_throw=True)
...
_register(0xFE, "const-method-handle", "21c", 2, ref_kind="method_handle", can_throw=True)
_register(0xFF, "const-method-type", "21c", 2, ref_kind="proto", can_throw=True)
